...
- **Email**: [jim@jimcresswell.net](mailto\:jim@jimcresswell.net)
...
- **Description**:
  - Leading app development, cloud infrastructure, and developer experience at Oak National Academy.
  - Focus on product strategy, CI/CD, developer experience, and overall cloud architecture.
  - Collaborated closely with stakeholders on strategic decision-making, digital strategy, and technical leadership.
  - Technologies used: Google Cloud Platform, Cloudflare, GitHub, Vercel, React, Next.js.

### Head of DevOps and Quality (Consulting)

- **Company**: Oak National Academy (remote)
...
- **Description**:
  - Provided strategic and technology consulting to both public and private sector clients.
  - Specialised in cloud computing, web applications, solution-oriented strategies, and open-source development.
...
- **Google Scholar Profile**: [James G. Cresswell - Google Scholar](https://scholar.google.com/citations?user=7yf2vEEAAAAJ\&hl=en\&oi=ao)

### Insititute of Cosmology and Gravitation - University of Portsmouth
...
Feel free to reach out via email for consultancy, automation, or development work.
